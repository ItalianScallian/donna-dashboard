...
import { o as getNormalizedURL, p as getOrigin, q as attachRouterServerSsrUtils, u as createSerializationAdapter, v as createRawStreamRPCPlugin, i as isNotFound, b as isRedirect, w as isResolvedRedirect, x as mergeHeaders, y as executeRewriteInput, z as defaultSerovalPlugins, A as makeSerovalPlugin, a as rootRouteId, C as defineHandlerCallback } from "../_chunks/_libs/@tanstack/router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BOkH0mGm.mjs");
...
async function loadEntries() {
  const routerEntry = await import("./router-CRxQrv7t.mjs");
